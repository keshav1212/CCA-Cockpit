...
const EXAMPLE_DATA: DataTableItem[] = [
  {MUs:'MALS' , Account: 'Total Accounts', Current:'', Jan:'', Feb:'', Mar:'', Apr:'', May:''},
  {MUs: 'CPRS', Account: 'Total Accounts', Current:'', Jan:'', Feb:'', Mar:'', Apr:'', May:''},
  ...
  private getSortedData(data: DataTableItem[]): DataTableItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'MUs': return compare(+a.MUs, +b.MUs, isAsc);
        case 'current': return compare(+a.Current, +b.Current, isAsc);
        ...
        case 'May': return compare(+a.May, +b.May, isAsc);
        default: return 0;
      }
    });
  }
