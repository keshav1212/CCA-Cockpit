...
@Component({
  selector: 'app-billable-fresher',
  templateUrl: './billable-fresher.component.html',
  styleUrls: ['./billable-fresher.component.css']
})
export class BillableFresherComponent {
